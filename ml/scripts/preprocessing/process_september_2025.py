"""
This script processes the raw September 2025 earthquake dataset by performing the following operations:
1. Convert the 'date_time' column to ISO 8601 format (e.g., 2025-09-30 23:57:00)
...
input_path = os.path.join(project_root, 'ml', 'dataset', 'earthquake', 'raw', 'raw_eq_data_2025_09.csv')
output_dir = os.path.join(project_root, 'ml', 'dataset', 'earthquake', 'interim')
output_path = os.path.join(output_dir, 'eq_data_2025_09_processed.csv')
...
def parse_date(dt):
    """
    Convert from format: "30 September 2025 - 11:57 PM" to "2025-09-30 23:57:00"
    """
    try:
...
print("="*60)
print(f"\nOutput file: eq_data_2025_09_processed.csv")
