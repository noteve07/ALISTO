...
def main():
    print("="*70)
    print("PROVINCE RISK CLUSTERING V4 (MINIMAL 2-FEATURE MODEL)")
    print("="*70)
    print("\nClustering Features:")
    print("1. total_quakes       - How active? (quantity)")
    print("2. major_quakes_m3plus - How dangerous? (M≥3.0)")
    print("\nScope: OVERALL (all data from 2018 onwards, no recent-only filter)")
    print("="*70)
    ...
    # Display results
    print("\n" + "="*70)
    print("RISK-BASED CLUSTERING RESULTS (V4 - MINIMAL)")
    print("="*70)
    ...
    # Save the plot
    output_path = os.path.join(os.path.dirname(__file__), 'province_risk_clustering_v4.png')
