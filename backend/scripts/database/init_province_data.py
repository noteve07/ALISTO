...
class ProvinceSeeder:
    ...
    def load_provinces_geojson(self) -> Dict:
        ...
        try:
            # Path to your provinces.json file (now in scripts/src/)
            json_path = Path(__file__).parent.parent / "src" / "provinces.json"
...
async def main():
    ...
    print("\n🔧 Checking PostGIS setup...")
    seeder.display_setup_instructions()
