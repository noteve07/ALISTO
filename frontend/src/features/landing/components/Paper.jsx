  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto">
        <div className="mb-16">
          <h3
            className={`text-center text-3xl md:text-4xl lg:text-5xl font-bold text-primary-v2 transition-all duration-700 delay-100 ${
              isVisible
          ...
          <p
            className={`text-center text-lg md:text-xl text-gray-600 mt-6 max-w-3xl mx-auto transition-all duration-700 delay-200 ${
              isVisible
                ? "opacity-100 translate-y-0"
                : "opacity-0 translate-y-5"
            }`}
        ...
        <div
          className={`flex flex-col md:flex-row gap-8 items-start max-w-5xl mx-auto transition-all duration-700 delay-300 ${
          ...
          <div className="flex-grow pl-0 md:pl-8 text-left">
            ...
            <div className="mt-6 space-y-3 text-gray-600">
              <div className="space-y-1 text-base md:text-lg">
                ...
                <p className="pl-0">
                  Michael Joseph M. Talabo, Jealla Rose M. Waje.
                </p>
