...
const SendIcon = ({ className = 'h-4 w-4' }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="m4 4 16 8-16 8 3-8-3-8Z" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
)
    ...
    () => [
      {
        id: 'isa-greeting',
        author: 'isa',
        content: 'Hi! I am ISA, your seismic assistant. How can I help you today?'
      },
      {
        id: 'sample-user',
        author: 'user',
