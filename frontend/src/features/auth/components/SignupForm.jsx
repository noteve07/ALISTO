...
/**
 * Signup form component - purely presentational
 * All logic handled by parent SignupPage
 */
const SignupForm = ({ formData, loading, error, onInputChange, onSubmit }) => {
  return (
    <div
      className="flex flex-col justify-center h-full bg-white relative z-10 overflow-y-auto py-8"
      style={{
    ...
    >
      ...
      <form onSubmit={onSubmit} className="space-y-4">
        ...
        <div className="flex items-start">
          <input
            ...
            type="checkbox"
            required
            className="w-4 h-4 mt-1 text-primary-v2 border-gray-300 rounded focus:ring-2 focus:ring-primary-v2 cursor-pointer"
          />
          <label
            htmlFor="terms"
          ...
          >
            ...
            <a
              href="#"
              className="text-primary-v2 hover:text-primary font-semibold"
            >
      ...
      {/* Social Signup (Optional - for future use) */}
      <div className="mt-6">
